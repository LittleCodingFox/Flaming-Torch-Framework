...
#define LUASCRIPTMANAGER_PRIORITY 5
#define RENDERER_PRIORITY 6
#define RESOURCEMANAGER_PRIORITY 7
#define INPUT_PRIORITY 8
#define SOUNDMANAGER_PRIORITY 9
#define FILESYSTEM_WATCHER_PRIORITY 10
#define PACKAGE_FILESYSTEM_PRIORITY 11
#define PROFILER_PRIORITY 12
