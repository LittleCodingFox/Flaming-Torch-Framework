...
#	define TAG "UIManager"
		...
		LayoutValue(NULL), RespondsToTooltipsValue(false), ClickTimer(0), IDValue(0)
	{
		...
		OnMouseJustPressed.Connect<UIPanel, &UIPanel::OnMouseJustPressedDraggable>(this);
		OnMouseReleased.Connect<UIPanel, &UIPanel::OnMouseReleasedDraggable>(this);

		OnMouseJustPressed.Connect<UIPanel, &UIPanel::OnMouseJustPressedScript>(this);
		OnMousePressed.Connect<UIPanel, &UIPanel::OnMousePressedScript>(this);
		OnMouseReleased.Connect<UIPanel, &UIPanel::OnMouseReleasedScript>(this);
		OnTouchDown.Connect<UIPanel, &UIPanel::OnTouchUpScript>(this);
		OnTouchUp.Connect<UIPanel, &UIPanel::OnTouchUpScript>(this);
		OnTouchDrag.Connect<UIPanel, &UIPanel::OnTouchDragScript>(this);
		OnKeyJustPressed.Connect<UIPanel, &UIPanel::OnKeyJustPressedScript>(this);
		OnKeyPressed.Connect<UIPanel, &UIPanel::OnKeyPressedScript>(this);
		OnKeyReleased.Connect<UIPanel, &UIPanel::OnKeyReleasedScript>(this);
		OnMouseMove.Connect<UIPanel, &UIPanel::OnMouseMovedScript>(this);
		OnCharacterEntered.Connect<UIPanel, &UIPanel::OnCharacterEnteredScript>(this);
		OnGainFocus.Connect<UIPanel, &UIPanel::OnGainFocusScript>(this);
		OnLoseFocus.Connect<UIPanel, &UIPanel::OnLoseFocusScript>(this);
		OnMouseEntered.Connect<UIPanel, &UIPanel::OnMouseEnteredScript>(this);
		OnMouseOver.Connect<UIPanel, &UIPanel::OnMouseOverScript>(this);
		OnMouseLeft.Connect<UIPanel, &UIPanel::OnMouseLeftScript>(this);
		OnClick.Connect<UIPanel, &UIPanel::OnClickScript>(this);
		OnDragBegin.Connect<UIPanel, &UIPanel::OnDragBeginScript>(this);
		OnDragEnd.Connect<UIPanel, &UIPanel::OnDragEndScript>(this);
		OnDragging.Connect<UIPanel, &UIPanel::OnDraggingScript>(this);
		OnDrop.Connect<UIPanel, &UIPanel::OnDropScript>(this);
		OnJoystickConnected.Connect<UIPanel, &UIPanel::OnJoystickConnectedScript>(this);
		OnJoystickDisconnected.Connect<UIPanel, &UIPanel::OnJoystickDisconnectedScript>(this);
		OnJoystickButtonJustPressed.Connect<UIPanel, &UIPanel::OnJoystickButtonJustPressedScript>(this);
		OnJoystickButtonPressed.Connect<UIPanel, &UIPanel::OnJoystickButtonPressedScript>(this);
		OnJoystickButtonReleased.Connect<UIPanel, &UIPanel::OnJoystickButtonReleasedScript>(this);
		OnJoystickAxisMoved.Connect<UIPanel, &UIPanel::OnJoystickAxisMovedScript>(this);
	};
